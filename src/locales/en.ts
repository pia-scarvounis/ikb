...
const en: Translation = {
  ...
  departments: {
    ...
    lead: "We have two great locations in the Gamlebyen area: a cosy wooden house for the youngest on Vålerenga, and a beautiful manor for the older children in Åkebergveien.",
    ...
    chips: {
      akeberg: [
        "42 children",
        "Sølvpilen · Månestråle",
        "Weekly excursion day",
      ],
      enebakk: [
        "27 children",
        "Askeladden · Tommeliten · Veslefrikk",
        "Weekly excursion day",
      ],
    },
    addresses: {
  ...
  dailySchedule: {
    ...
    lead: "A small insight into what our days look like and what shapes everyday life in the kindergarten.",
  ...
  parents: {
    ...
    lead: "In close collaboration with parents, we aim to provide a safe, supportive and positive start for every child.",
    readMore: "Read more",
    close: "Close",
    cards: [
      {
      ...
      },
      {
        ...
        links: [
          { label: "Annual plan Åkeberg", url: "/pdfs/arsplan-akeberg.pdf" },
          {
